...
const technologies: ITechnology[] = [
    ...
    { name: "C#", icon: <SiCsharp />, year: 2022, type: "Programming" },
    { name: "HTML5", icon: <SiHtml5 />, year: 2020, type: "Web" },
    { name: "CSS3", icon: <SiCss3 />, year: 2020, type: "Web" },
...
function ItemContainer({ tech }: { tech: ITechnology }) {
    return (
        <div 
            className="p-6 bg-neutral-100 dark:bg-[#242424] backdrop-blur-lg rounded-lg border border-white/10 transition-all duration-300 dark:hover:border-darkaccent hover:border-accent dark:hover:shadow-[0_0_10px_#2DC8C5] hover:shadow-[0_0_10px_#12918F]"
        >
            ...
            <div className="mt-3 flex flex-row items-center gap-2">
                <p className="bg-lightbtnhover dark:bg-darkbtnhover px-2 py-1 rounded-lg lg:text-base">{ tech.year }</p>
                <p className="bg-lightbtnhover dark:bg-darkbtnhover px-2 py-1 rounded-lg lg:text-base">{ tech.type }</p>
            </div>
        </div>
    )
}